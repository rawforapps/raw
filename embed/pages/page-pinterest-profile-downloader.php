<?php
/**
 * Template Name: Pinterest Profile Downloader Page
 * The template file for the Pinterest Profile Downloader page (slug: pinterest-profile-downloader)
 *
...
<main id="pd-page" class="pd-site-main">
	...
	<!-- =========================================================
	     1. HERO & TOOL SECTION (PROFILE DOWNLOADER)
	========================================================= -->
	<section class="pd-hero-section" aria-label="Pinterest Profile Downloader">
		<div class="pd-hero-glow" aria-hidden="true"></div>
		<div class="pd-container pd-hero">

			<div class="pd-hero__eyebrow">
				<span>Up to 100 Pins &bull; ZIP Download &bull; Free</span>
			</div>
			...
			<p class="pd-hero__subtitle">
				Save public pins from an entire Pinterest profile, across every board they've made. Free, no watermark, no account needed.
			</p>
	...
	========================================================= -->
	<section class="pd-section pd-content-section" aria-label="Profile Guide and Details">
	...
	<section class="pd-cta" aria-label="Call to Action">
		<div class="pd-container">
			<h2>Ready to Save Their Profile?</h2>
...
$pd_schema_software = array(
	...
	'description'         => 'Download every public pin from a Pinterest profile with PinsDownload. Up to 100 pins per request, free, no login needed.',
);
?>
...
$pd_schema_howto = array(
	'@context'         => 'https://schema.org',
	'@type'            => 'HowTo',
	'name'             => 'How to Download Pins From a Pinterest Profile',
	'step'             => array(
		array(
			'@type' => 'HowToStep',
			'text'  => 'Open the Pinterest profile you want to save.',
		),
		array(
			'@type' => 'HowToStep',
			'text'  => 'Copy the profile link. It looks like pinterest.com/username or a country-domain link like in.pinterest.com/username.',
		),
		array(
			'@type' => 'HowToStep',
...
$pd_schema_breadcrumb = array(
	...
	'itemListElement' => array(
		...
		array(
			'@type'    => 'ListItem',
			'position' => 2,
			'name'     => 'Pinterest Profile Downloader',
			'item'     => $pd_page_id ? get_permalink( $pd_page_id ) : home_url( '/pinterest-profile-downloader/' ),
		),
	),
);
?>
